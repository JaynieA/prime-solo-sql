...
UPDATE syntax_practice SET account_balance = 0  WHERE account_balance = 0.0 AND transactions_attempted = 0;
...
SELECT username, account_balance FROM syntax_practice LIMIT 3;
...
--Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('jAnderson', 'Minneapolis', 5, 5, 500000000);
